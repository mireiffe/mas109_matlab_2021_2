...
1. Write a code that executes modified Gram-Schmidt by referring to the algorithm of [MGS]({{site.baseurl}}/week12/assign8/#2-modified-gram-schmidt-algorithm-mgs-1). (Hint: [Exercise 7.13]({{site.baseurl}}/week12/ex9/#exercise-713-orthonormal-bases-for-the-four-fundamental-spaces))
